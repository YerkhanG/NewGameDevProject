...
using map_encounter_system.map_system.UI.line.utilities;
using UnityEditor.Sprites;
using UnityEngine;
using UnityEngine.UI;

namespace map_encounter_system.map_system.UI.line
{
    ...
    public class UILineRenderer : UIPrimitiveBase
	{
		...
		private void PopulateMesh(VertexHelper vh, Vector2[] pointsToDraw)
		{
			...
			/*if (ImproveResolution == LightProbeProxyVolume.ResolutionMode.None) {
        ...
        protected override void GeneratedUVs()
        {
            ...
            {
                var outer = SpriteUtility.GetSpriteUVs(activeSprite,false);
                UV_TOP_LEFT = new Vector2(outer, outer.y);
